 ...
 */
public class ArtifactRequestCreationProcessorConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(ArtifactRequestCreationProcessorConsumer.class);

    private final ArtifactRequestCreationProcessorEndpoint endpoint;


    public ArtifactRequestCreationProcessorConsumer(final ArtifactRequestCreationProcessorEndpoint endpoint, final Processor processor) {
